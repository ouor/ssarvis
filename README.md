...
공개 클론/공개 음성을 사용해 시작한 대화도 저장 주체는 현재 로그인 회원입니다.
...
공개 클론/공개 음성을 사용해 시작한 논쟁도 저장 주체는 현재 로그인 회원입니다.
