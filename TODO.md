...
1. 타 사용자 프로필/게시물 탐색 UX 추가
2. Settings 화면 구조를 PRD 기준으로 정리
...
- 다음 작업은 `TODO 1`을 중심으로 타 사용자 프로필 탐색을 붙여 프로필 경험을 실제 SNS 흐름으로 완성하는 것이다
